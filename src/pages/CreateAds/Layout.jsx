...
import { Grid, Card, CardHeader, CardMedia, CardActions, CardContent, Checkbox, 
  FormControlLabel, Typography, Button, Box  } from '@mui/material';
...
const Layout = () => {
  ...
  return (
    <Card variant="outlined" sx={{ margin: '0px 10px' }}>
      ...
      <CardActions sx={{ justifyContent: 'flex-end', paddingTop: '100px' }}>
        <Button variant="contained" size="large" onClick={onNextClick} disabled={selectedItems.length === 0}>Next</Button>
      </CardActions>
    </Card>
  );
}
